...
* [Configure the Spring AOT Plugin](https://docs.spring.io/spring-native/docs/0.11.0-SNAPSHOT/reference/htmlsingle/#spring-aot-gradle)
...
see [the Getting Started section of the reference guide](https://docs.spring.io/spring-native/docs/0.11.0-SNAPSHOT/reference/htmlsingle/#getting-started-buildpacks)
.
...
see [the Getting Started section of the reference guide](https://docs.spring.io/spring-native/docs/0.11.0-SNAPSHOT/reference/htmlsingle/#getting-started-native-build-tools)
.
